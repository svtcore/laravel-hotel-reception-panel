...
Route::middleware(['role:receptionist'])->group(function () {
    Route::namespace('receptionist')->group(function () {
        ...
        Route::prefix('guests')->group(function () {
            ...
            Route::get('/create', 'GuestController@create')->name('guests.create');
            Route::post('/create/relation/', 'GuestController@relation')->name('guests.relation');
            Route::delete('/relation/delete', 'GuestController@deleteRelation')->name('guests.relation.delete');
            Route::post('/', 'GuestController@store')->name('guests.store');
            Route::post('/search', 'GuestController@searchByParams')->name('guests.search');
            Route::post('/relation/search', 'GuestController@searchRelation')->name('guests.search.relation');
            Route::post('/relation/submit', 'GuestController@submitRelation')->name('guests.relation.submit');
        });
