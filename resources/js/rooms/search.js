...
$(document).ready(function () {
    var element = $("#search-results-rooms-table");
    $('html, body').animate({
    ...
    $("#search-results-rooms-table").DataTable({
        "responsive": true,
        "lengthChange": false,
        "autoWidth": false,
        "searching": false,
    ...
    $('#search-results-rooms-table tbody').on('mouseenter', 'tr', function() {
        $(this).addClass('highlight');
    });
    
    $('#search-results-rooms-table tbody').on('mouseleave', 'tr', function() {
