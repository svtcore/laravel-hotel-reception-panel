                                        ...
                                        <table class="table">
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td class="text-left"><a href="{{ route('guests.show', $booking_data->guests[0]->id) }}">{{ $booking_data->guests[0]->first_name }} {{ $booking_data->guests[0]->last_name }}</a></td>
                                                </tr>
                                                <tr>
                                                ...
                                                <tr>
                                                    <form action="{{ route('guests.relation.submit') }}" method="POST">
                                                    @csrf
                                                    <td class="text-left">
                                                        <div class="input-group">
                                                            <input type="hidden" name="search_guest_url" id="search_guest_url" value="{{ route('guests.search.relation') }}" />
                                        ...
                                        <table class="table">
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-right">
                                                        <form action="{{ route('guests.relation.delete') }}" method="POST">
                                                            @csrf
                                                            @method('DELETE')
