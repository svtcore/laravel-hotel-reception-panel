...
<span id="header_guests_edit">Edit guest</span>
@endsection
    ...
    <div class="content-container main-container">
        <section class="content">
            <div class="container-fluid">
                ...
                @endif
                <form id="editForm" action="{{ route(Auth::user()->hasRole('admin') ? 'admin.guests.update' : (Auth::user()->hasRole('receptionist') ? 'receptionist.guests.update' : '#'), $guest->id) }}" method="POST">
                    <div class="row">
                        <div class="col-md-5">
