                            ...
                            <div class="form-row">
                                ...
                                <div class="col-md-2 pt-2">
                                    ...
                                    <select class="form-select text-center" id="adultsBedsCount" name="adultsBedsCount" required>
                                        ...
                                        @for ($i = 1; $i <= 10; $i++) <option value="{{ $i }}" @if (isset($inputData['adultsBedsCount']) && $inputData['adultsBedsCount']==$i) selected @endif>
                                ...
                                <div class="col-md-2 pt-2">
                                    ...
                                    <select class="form-select text-center" id="childrenBedsCount" name="childrenBedsCount" required>
                                        ...
                                        <option value="0" @if (isset($inputData['childrenBedsCount']) && $inputData['childrenBedsCount']==0) selected @endif>NO
                                            CHILD BED</option>
                                        @for ($i = 1; $i <= 10; $i++) <option value="{{ $i }}" @if (isset($inputData['childrenBedsCount']) && $inputData['childrenBedsCount']==$i) selected @endif>
