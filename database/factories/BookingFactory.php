...
class BookingFactory extends Factory
{
    ...
    public function definition(): array
    {
        return [
            //room_id
            'adult_amount' => $this->faker->numberBetween(1,10),
            'children_amount' => $this->faker->numberBetween(0,4),
            'total_cost' => $this->faker->numberBetween(1000, 10000),
            'payment_type' => $this->faker->randomElement(['credit_card', 'cash']),
            'check_in_date' => $this->faker->dateTimeInInterval('-1 week', '+14 days'),
            'check_out_date' => $this->faker->dateTimeInInterval('now', '+14 days'),
            'note' => $this->faker->sentence(),
            'status' => $this->faker->randomElement(['reserved', 'canceled', 'active', 'expired', 'completed']),
        ];
    }
}
